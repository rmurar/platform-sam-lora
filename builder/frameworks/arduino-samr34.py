...
def dev_init(env, platform):
    ...
    env.Append(
        ...
        CPPPATH = [ 
            ...
            join(env.framework_dir,  platform, "libraries", "RF"),
            join(env.framework_dir,  platform, "libraries", "SPI"),
            join(env.framework_dir,  platform, "libraries", "AES"),
            join(env.framework_dir,  platform, "libraries", "Beelan-LoRaWAN"),
            join(env.framework_dir,  platform, "libraries", "Lora"),
            join(env.framework_dir,  platform, "libraries", "LoRaLib"),
            join(env.framework_dir,  platform, "libraries", "TIMER"),
            join(env.framework_dir,  platform, "libraries", "Wire"),
